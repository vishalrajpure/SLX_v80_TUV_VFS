...
<SalesLogix:LookupControl runat="server" ID="QFTextBox" LookupEntityName="Product" LookupEntityTypeName="Sage.Entity.Interfaces.IProduct, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupBindingMode="String" SeedProperty="$qfcontrol.SeedProperty" InitializeLookup="true" AddEmptyListItem="false"  >
<LookupProperties>
