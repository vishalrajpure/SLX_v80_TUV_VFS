...
MaxLength="32"  />
                ...
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="Branch_lbl" AssociatedControlID="Branch" runat="server" Text="<%$ resources: Branch.Caption %>" ></asp:Label>
 </div>   
  <div    >
<SalesLogix:LookupControl runat="server" ID="Branch" ReadOnly="true" EnableLookup="false" LookupEntityName="Branch" LookupEntityTypeName="Sage.Entity.Interfaces.IBranch, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="DropDownList" LookupBindingMode="String" DropDownDisplayProperty="BranchName"  >
<LookupProperties>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
...
protected override void OnAddEntityBindings() {
        ...
        BindingSource.Bindings.Add(phnWorkPhoneTextBinding);
                    // Branch.LookupResultValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding BranchLookupResultValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("Account.BranchId", Branch, "LookupResultValue");
        BindingSource.Bindings.Add(BranchLookupResultValueBinding);
...
public class ContactDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IContactDetails
{
    ...
    private Sage.Platform.Controls.ILookupControl _Branch;
    public  Sage.Platform.Controls.ILookupControl Branch
    {
        get { return FindControl(ref _Branch, "Branch"); }
    }
