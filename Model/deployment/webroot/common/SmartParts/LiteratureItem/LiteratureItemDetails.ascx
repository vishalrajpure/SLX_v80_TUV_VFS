<%@ Control Language="C#" ClassName="LiteratureItemDetails" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<asp:TextBox runat="server" ID="Itemnumber"  dojoType="Sage.UI.Controls.TextBox" MaxLength="15"  />
  </div>
...
<tr>
 ...
 <div class="twocollbl alignleft">
   ...
   <div  class="twocoltextcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="Itemfamily" PickListName="Literature Families" MustExistInList="false"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="ModifyDate" ButtonToolTip="<%$ resources: ModifyDate.ButtonToolTip %>" DisplayTime="false" />
  </div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="LiteratureItemDetails_RTools" ToolbarLocation="right">
 ...
 />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=LiteratureItemDetails&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkLiteratureItemDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="LiteratureItemDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding ModifyDateDateTimeValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ModifyDate", ModifyDate, "DateTimeValue");
...
protected void btnDelete_ClickActionBRC(object sender, EventArgs e) {
      Response.Redirect("LiteratureItem.aspx");
...
{
    get { return _formAdapter ?? (_formAdapter = new LiteratureItemDetailsAdapter(this)); }
}

public class LiteratureItemDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ILiteratureItemDetails
{
    public LiteratureItemDetailsAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
