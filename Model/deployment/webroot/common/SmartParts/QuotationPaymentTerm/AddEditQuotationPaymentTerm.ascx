<%@ Control Language="C#" ClassName="AddEditQuotationPaymentTerm" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<asp:TextBox runat="server" ID="Description"  dojoType="Sage.UI.Controls.TextBox" MaxLength="128"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditQuotationPaymentTerm_RTools" ToolbarLocation="right">
...
ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Delete_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditQuotationPaymentTerm&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditQuotationPaymentTermHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditQuotationPaymentTerm" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
    get { return typeof(Sage.Entity.Interfaces.IQuotationPaymentTerm); }
}
...
protected void btnSave_ClickAction(object sender, EventArgs e) {
  Sage.Entity.Interfaces.IQuotationPaymentTerm _entity = BindingSource.Current as Sage.Entity.Interfaces.IQuotationPaymentTerm;
  if (_entity != null)
  {
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditQuotationPaymentTermAdapter(this)); }
}

public class AddEditQuotationPaymentTermAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditQuotationPaymentTerm
{
    public AddEditQuotationPaymentTermAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
