...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.ActualId.PropertyHeader %>" PropertyName="ActualId" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.Name.PropertyHeader %>" PropertyName="Name" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.Vendor.PropertyHeader %>" PropertyName="Vendor" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
...
<asp:TextBox runat="server" ID="txtDescription" Enabled="false" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkReturned"  Text="<%$ resources: chkReturned.Caption %>"  CssClass=""
...
Visible="false" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSerializePrefix"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSerializeStart"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSerializeIncrement"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkEvaluation"  Text="<%$ resources: chkEvaluation.Caption %>"  CssClass=""
...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssetContact.LookupProperties.NameLF.PropertyHeader %>" PropertyName="NameLF" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssetContact.LookupProperties.Account.AccountName.PropertyHeader %>" PropertyName="Account.AccountName" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssetContact.LookupProperties.WorkPhone.PropertyHeader %>" PropertyName="WorkPhone" PropertyType="" PropertyFormat="Phone" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
</SalesLogix:LookupControl>
...
ReadOnly="true" Enabled="false"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtOpportunity" Enabled="false" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<SalesLogix:Email runat="server" ID="emlContactEmail" ReadOnly="true" ButtonToolTip="<%$ resources: emlContactEmail.ButtonToolTip %>" EmailTextBoxStyle-ForeColor="#000099" EmailTextBoxStyle-Font-Underline="false" />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSalesOrder" Enabled="false" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtLocation"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtAssetCode"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtEnvironment"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSystem"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtVersion"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dteModifyDate" ReadOnly="true" />
  </div>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditAccountProduct_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditAccountProduct&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditAccountProductHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditAccountProduct" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
