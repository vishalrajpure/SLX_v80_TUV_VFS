...
<div class="slxlabel  alignleft checkboxRight">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkDefault"  Text="<%$ resources: chkDefault.Caption %>"  CssClass=""
LabelPlacement="left"  />
</div>
      </td>
      </tr>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditProductPrice_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditProductPrice&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditProductPriceHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditProductPrice" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
