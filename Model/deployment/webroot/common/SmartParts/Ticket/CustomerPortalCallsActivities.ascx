<%@ Control Language="C#" ClassName="CustomerPortalCallsActivities" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<script runat="server" type="text/C#">
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CustomerPortalCallsActivities_RTools" ToolbarLocation="right">
 ...
 AlternateText="<%$ resources: cmdTicketActivities.Caption %>"  ToolTip="<%$ resources: cmdTicketActivities.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=CustomerPortalCallsActivities&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkCustomerPortalCallsActivitiesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CustomerPortalCallsActivities" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
