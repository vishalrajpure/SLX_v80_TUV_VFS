<%@ Control Language="C#" ClassName="CallsHistory_PrintView" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:ScriptResourceProvider ID="CallsHistory_PrintViewQFSDataGrid_Strings" runat="server">
    <Keys>
  ...
  <div id="CallsHistory_PrintViewQFSDataGrid_Container" style="width:100%;height:100%;" class="">
    <div id="CallsHistory_PrintViewQFSDataGrid_Grid" style="width:100%;height:100%;"
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CallsHistory_PrintView_RTools" ToolbarLocation="right">
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=CallsHistory_PrintView&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkCallsHistory_PrintViewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CallsHistory" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
dtsHistory.Bind();
                                ...
                                script.AppendLine("require(['" + Page.ResolveUrl("~/SmartParts/Ticket/CallsHistory_PrintView.js") + "'], function () {");
                                if (Page.IsPostBack)
                                {
