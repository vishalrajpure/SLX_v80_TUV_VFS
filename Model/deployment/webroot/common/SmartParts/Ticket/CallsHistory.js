...
makeGrid : function(runtimeConfig) {
    ...
    if (typeof CallsHistoryQFSDataGrid_Strings === 'undefined') {
        CallsHistoryQFSDataGrid_Strings = {};
    }

    var options = {		
		        context: runtimeConfig,		
		        noDataMessage: CallsHistoryQFSDataGrid_Strings['QFSDataGrid_EmptyTableRowText']  ||  'No records match the selection criteria.', 
...
{
		field: 'CreateDate',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_172d76f3_99b4_4ea1_8414_da75e5e88912_ColumnHeading']  || 'Date Changed',
	sortable: true,
		width: 12,
		styles: 'width:auto;',
...
{
		field: 'CreateUser',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_51deac7c_b02d_44ec_97ca_b8fea21eea43_ColumnHeading']  || 'User',
	sortable: true,
		width: 12,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
{
		field: 'FieldName',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_d1f6b256_d567_40b6_ae8a_8a3bc328b642_ColumnHeading']  || 'Field Changed',
	sortable: false,
		width: 12,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
{
		field: 'OldValue',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_19b71659_8053_4cb9_8f99_81170e06c1f7_ColumnHeading']  || 'Old Value',
	sortable: true,
		width: 12,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
{
		field: 'NewValue',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_de9a042c_2163_485e_8896_186e17d886ca_ColumnHeading']  || 'New Value',
	sortable: true,
		width: 12,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
{
		field: 'Note',
				name:  CallsHistoryQFSDataGrid_Strings['QFSDataGrid_0bed4c04_75b7_4c30_b38f_adc480b39157_ColumnHeading']  || 'Note',
	sortable: false,
		width: '10',
	 	styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
, 
	...
	editable: false
	    ...
	    //The .net vehicle to store grid data on postback
            dataCarrierId: 'CallsHistoryQFSDataGrid_DataCarrier',
            sort: [
    { attribute: "CreateDate"
        ...
        contextualCondition: function() { return 'Ticket.Id eq "' + Sage.Utility.getCurrentEntityId() + '"'; },
						...
						tabId : 'CallsHistory',
		gridNodeId: 'CallsHistoryQFSDataGrid_Grid',
				id : 'CallsHistoryQFSDataGrid',
        rowsPerPage: 20,
  ...
  ,
    ...
    init : function(runtimeConfig) {
        setTimeout(function() { Sage.UI.Forms.CallsHistory.makeGrid(runtimeConfig); }, 1);
