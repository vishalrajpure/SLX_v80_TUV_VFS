<%@ Control Language="C#" ClassName="CallsExtendedDetails_PrintView" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<asp:Label runat="server" ID="txtResolution" style="white-space:normal"  />
  ...
  <SalesLogix:LookupControl runat="server" ID="lueStandardResolution"  ToolTip="<%$ resources: lueStandardResolution.ToolTip %>" LookupEntityName="TicketSolutionType" LookupDisplayMode="Text" AutoPostBack="true" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=Find_16x16"  >
<LookupProperties>
...
<LookupPreFilters>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CallsExtendedDetails_PrintView_RTools" ToolbarLocation="right">
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=CallsExtendedDetails_PrintView&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkCallsExtendedDetails_PrintViewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CallsExtendedDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
    get { return _formAdapter ?? (_formAdapter = new CallsExtendedDetailsAdapter(this)); }
}

public class CallsExtendedDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ICallsExtendedDetails
{
    public CallsExtendedDetailsAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
