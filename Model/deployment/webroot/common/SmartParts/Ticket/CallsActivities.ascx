<%@ Control Language="C#" ClassName="CallsActivities" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:ScriptResourceProvider ID="CallsActivitiesgrdTicketActivities_Strings" runat="server">
    <Keys>
...
<div style="display:none;">
  <asp:TextBox runat="server" ID="CallsActivitiesgrdTicketActivities_DataCarrier" class="CallsActivitiesgrdTicketActivities_DataCarrier" ></asp:TextBox>
</div>
  <div id="CallsActivitiesgrdTicketActivities_Container" style="width:100%;height:100%;" class="">
    <div id="CallsActivitiesgrdTicketActivities_Grid" style="width:100%;height:100%;"
></div>
</div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CallsActivities_RTools" ToolbarLocation="right">
 ...
 <SalesLogix:PageLink ID="lnkCallsActivitiesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CallsActivities" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
ScriptManager.RegisterStartupScript(Page, GetType(), "cleanupcontainer", "jQuery(\".controlslist > div:empty\").remove();", true);
 ...
 if (entity != null) 
      ...
      { 
          ...
          CallsActivitiesgrdTicketActivities_DataCarrier.Text = text; 
...
dtsTicketActivityDataSource.Bind();
                                ...
                                script.AppendLine("require(['" + Page.ResolveUrl("~/SmartParts/Ticket/CallsActivities.js") + "'], function () {");
                                if (Page.IsPostBack)
                                {
