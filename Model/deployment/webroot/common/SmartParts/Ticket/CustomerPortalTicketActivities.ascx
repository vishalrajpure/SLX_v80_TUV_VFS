<%@ Control Language="C#" ClassName="CustomerPortalTicketActivities" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<script runat="server" type="text/C#">
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CustomerPortalTicketActivities_RTools" ToolbarLocation="right">
    <asp:ImageButton runat="server" ID="cmdTicketActivities"
 AlternateText="<%$ resources: cmdTicketActivities.Caption %>"  ToolTip="<%$ resources: cmdTicketActivities.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=CustomerPortalTicketActivities&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkCustomerPortalTicketActivitiesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CustomerPortalTicketActivities" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected void cmdSubmit_ClickAction(object sender, EventArgs e) {
         ...
         Sage.Platform.EntityFactory.Execute<Sage.Entity.Interfaces.ITicket>("TicketActivity.AddTicketActivity", objarray);
