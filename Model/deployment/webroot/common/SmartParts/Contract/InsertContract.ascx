...
<asp:TextBox runat="server" ID="txtReference"  dojoType="Sage.UI.Controls.TextBox"  />
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklService" PickListName="Contract Service Type" StorageMode="ID"  />
  </div>
...
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAccount.LookupProperties.AccountManager.UserInfo.UserName.PropertyHeader %>" PropertyName="AccountManager.UserInfo.UserName" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAccount.LookupProperties.Owner.OwnerDescription.PropertyHeader %>" PropertyName="Owner.OwnerDescription" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklType" PickListName="Contract Type" AutoPostBack="true" NoneEditable="true" StorageMode="ID"  />
  </div>
...
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueContact.LookupProperties.WorkPhone.PropertyHeader %>" PropertyName="WorkPhone" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkFirst"  Text="<%$ resources: chkFirst.Caption %>"  CssClass=""
...
<asp:TextBox runat="server" ID="txtComments"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
 ...
 AlternateText="<%$ resources: cmdDateStamp.Caption %>"  ToolTip="<%$ resources: cmdDateStamp.ToolTip %>" CssClass="padleft" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=User_Date_Stamp_16x16"  />
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtGraceDays"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
AutoPostBack="true"  />
 ...
 <SalesLogix:PageLink ID="lnkInsertContractHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="InsertContract" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
if (Request.QueryString[Sage.Platform.WebPortal.EntityPage.CONST_ENTITYIDQUERYSTRING] != null)
{
    ...
    Sage.Entity.Interfaces.IContract contract =
        Sage.Platform.EntityFactory.GetRepository<Sage.Entity.Interfaces.IContract>().FindFirstByProperty("Id", id);
...
Sage.SalesLogix.PickLists.PickList picklist =
    Sage.SalesLogix.PickLists.PickList.GetPickListById(newContract.TypeCode);
if (picklist != null)
{
    ...
    chkFirst.Enabled = (value == GetLocalResourceObject("ContractType_Days").ToString().ToUpper());
...
ClientBindingMgr.SetFocusTo(txtReference);
