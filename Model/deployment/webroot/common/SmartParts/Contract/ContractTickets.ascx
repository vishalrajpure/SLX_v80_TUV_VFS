...
<Columns>
   ...
   <SalesLogix:DateTimePicker runat="server" ID="grdTicketscol5"  DisplayMode="AsText" DateTimeValue='<%#  dtsTickets.getPropertyValue(Container.DataItem, "CompletedDate")  %>'  CssClass=""  />
    ...
    <itemtemplate>
 <SalesLogix:Currency runat="server" ID="grdTicketscol7" DisplayMode="AsText"  ExchangeRateType="BaseRate"   Text='<%#  dtsTickets.getPropertyValue(Container.DataItem, "Dollars")  %>' CssClass=""  DecimalDigits="2"  />
   </itemtemplate></asp:TemplateField>
  ...
  DataFormatString="<%$ resources: grdTickets.c671cf18-1f2d-47cc-88c0-968d6c328f96.FormatString %>" HtmlEncode="false"    HeaderText="<%$ resources: grdTickets.c671cf18-1f2d-47cc-88c0-968d6c328f96.ColumnHeading %>"   itemstyle-horizontalalign="Right"        >
    ...
    <itemtemplate>
 <SalesLogix:Currency runat="server" ID="grdTicketscol9" DisplayMode="AsText"  ExchangeRateType="BaseRate"   Text='<%#  dtsTickets.getPropertyValue(Container.DataItem, "TotalParts")  %>' CssClass=""  DecimalDigits="2"  />
   </itemtemplate></asp:TemplateField>
...
protected void grdTickets_Sorting(object sender, GridViewSortEventArgs e) { }
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="ContractTickets_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=ContractTickets&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkContractTicketsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="ContractTickets" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
