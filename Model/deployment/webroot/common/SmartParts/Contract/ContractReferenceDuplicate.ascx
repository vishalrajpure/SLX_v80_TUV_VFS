...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 AllowSorting="true" OnSorting="grdDuplicates_Sorting"  ShowSortIcon="true"  OnPreRender="grdDuplicates_PreRender" >
<Columns>
...
protected void grdDuplicates_PreRender(object sender, EventArgs e)
{
...
<asp:TextBox runat="server" ID="txtComments" Enabled="false" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<asp:RadioButtonList runat="server"  onclick="dojo.publish('Sage/events/markDirty')" ID="rdgOptions" RepeatDirection="Vertical"  >
</asp:RadioButtonList>
</fieldset>
      </td>
            </tr>
...
ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=ContractReferenceDuplicate&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkContractReferenceDuplicateHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="ContractReferenceDuplicate" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
