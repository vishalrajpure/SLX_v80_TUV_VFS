...
<asp:TextBox runat="server" ID="txtName"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtDescription"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea" MultiLineMaxLength="256"  />
  </div>
...
<tr>
 ...
 />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=PackageDetails&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkPackageDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="PackageDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
if (RoleSecurityService.HasAccess("ENTITIES/PACKAGE/EDIT"))
{
...
if (RoleSecurityService != null)
{
if (RoleSecurityService.HasAccess("ENTITIES/PACKAGE/ADD"))
{
