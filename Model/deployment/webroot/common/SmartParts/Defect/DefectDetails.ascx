...
<asp:TextBox runat="server" ID="txtDefectID" Enabled="false"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkAddtoSearch"  Text="<%$ resources: chkAddtoSearch.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<tr>
 ...
 <SalesLogix:PageLink ID="lnkDefectDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="DefectDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
