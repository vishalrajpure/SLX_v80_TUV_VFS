...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 AllowSorting="true" OnSorting="grdTickets_Sorting"  OnRowDeleting="grdTickets_RowDeleting" OnRowDataBound="grdTickets_RowDataBound"  ShowSortIcon="true"  OnPreRender="grdTickets_PreRender" >
<Columns>
...
<asp:TextBox runat="server" ID="txtSubject" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class="lbltop alignleft">
  ...
  <div  class="twocoltextcontrol"   >
<asp:TextBox runat="server" ID="memDescription" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<tr>
 ...
 <div class="lbltop alignleft">
  ...
  <div  class="twocoltextcontrol"   >
<asp:TextBox runat="server" ID="memResolution" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="DefectTickets_RTools" ToolbarLocation="right">
   <SalesLogix:LookupControl runat="server" ID="lueAssociateTicket"  ToolTip="<%$ resources: lueAssociateTicket.ToolTip %>" ButtonToolTip="<%$ resources: lueAssociateTicket.ButtonToolTip %>" LookupEntityName="Ticket" LookupEntityTypeName="Sage.Entity.Interfaces.ITicket, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="ButtonOnly" AutoPostBack="true" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=plus_16x16"  >
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.TicketNumber.PropertyHeader %>" PropertyName="TicketNumber" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.Account.AccountName.PropertyHeader %>" PropertyName="Account.AccountName" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.Contact.NameLF.PropertyHeader %>" PropertyName="Contact.NameLF" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.Contact.WorkPhone.PropertyHeader %>" PropertyName="Contact.WorkPhone" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.StatusCode.PropertyHeader %>" PropertyName="StatusCode" PropertyType="SalesLogix.PickList" PropertyFormat="PickList" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.Urgency.Description.PropertyHeader %>" PropertyName="Urgency.Description" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateTicket.LookupProperties.Area.PropertyHeader %>" PropertyName="Area" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=DefectTickets&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkDefectTicketsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="DefectTickets" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dtsTickets.BindFieldNames = new String[] { "Id","Ticket.Id","Ticket.TicketNumber","Ticket.ReceivedDate","Ticket.Account.Id","Ticket.Account.AccountName","Ticket.StatusCode","Ticket.Urgency.Description","Ticket.NeededByDate","Ticket.Subject","Ticket.TicketProblem.Notes","Ticket.TicketSolution.Notes" };
...
protected void lueAssociateTicket_ChangeAction(object sender, EventArgs e) {
			...
			if (lueAssociateTicket.LookupResultValue != null)
		{
			...
			{
						foreach (Sage.Entity.Interfaces.IDefectTicket i in parentEntity.DefectTickets)
				{				
					if (i.Ticket.Equals(relatedEntity))
					{
						found = true;
						if (DialogService != null)
						{
							DialogService.ShowMessage(base.GetLocalResourceObject("09ad58d5-bbc2-4661-9958-358b728c3728.DuplicateAssociationMessage").ToString(), 90, 360);
							return;
						}
					}
				}
