...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 AllowSorting="true" OnSorting="grdReturns_Sorting"  OnRowDeleting="grdReturns_RowDeleting" OnRowDataBound="grdReturns_RowDataBound"  ShowSortIcon="true"  OnPreRender="grdReturns_PreRender" >
<Columns>
...
protected void grdReturns_PreRender(object sender, EventArgs e)
{
...
<asp:TextBox runat="server" ID="txtReturnNotes" Enabled="false" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<tr>
 ...
 <div class="lbltop alignleft">
  ...
  <div  class="twocoltextcontrol"   >
<asp:TextBox runat="server" ID="memComments" Enabled="false" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="DefectReturns_RTools" ToolbarLocation="right">
   <SalesLogix:LookupControl runat="server" ID="lueAssociateReturn" ButtonToolTip="<%$ resources: lueAssociateReturn.ButtonToolTip %>" LookupEntityName="Return" LookupEntityTypeName="Sage.Entity.Interfaces.IReturn, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="ButtonOnly" AutoPostBack="true" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=plus_16x16"  >
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateReturn.LookupProperties.ReturnNumber.PropertyHeader %>" PropertyName="ReturnNumber" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateReturn.LookupProperties.Account.AccountName.PropertyHeader %>" PropertyName="Account.AccountName" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateReturn.LookupProperties.SubmittedBy.CreateUser.PropertyHeader %>" PropertyName="SubmittedBy.CreateUser" PropertyType="" PropertyFormat="User" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateReturn.LookupProperties.ShipTo.NameLF.PropertyHeader %>" PropertyName="ShipTo.NameLF" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="True"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateReturn.LookupProperties.Ticket.TicketNumber.PropertyHeader %>" PropertyName="Ticket.TicketNumber" PropertyType="" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=DefectReturns&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkDefectReturnsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="DefectReturns" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dtsReturns.BindFieldNames = new String[] { "Id","Return.Id","Return.ReturnNumber","Return.CreateDate","Return.ReturnType","Return.Status","Return.Priority","Return.ReturnedBy","Return.ReturnDetailNotes","Return.ShipTo","Return.ReturnShippedAddress.City","Return.ReturnShippedAddress.Country","Return.ReturnShippedAddress.County","Return.ReturnShippedAddress.Address1","Return.ReturnShippedAddress.Address2","Return.ReturnShippedAddress.Address3","Return.ReturnShippedAddress.Description","Return.ReturnShippedAddress.FullAddress","Return.ReturnShippedAddress.PostalCode","Return.ShipViaCode","Return.Notes" };
...
protected void lueAssociateReturn_ChangeAction(object sender, EventArgs e) {
			...
			if (lueAssociateReturn.LookupResultValue != null)
		{
			...
			if ((parentEntity != null) && (relatedEntity != null))
			{
				...
				{				
					if (i.Return.Equals(relatedEntity))
					{
						found = true;
						if (DialogService != null)
						{
							DialogService.ShowMessage(base.GetLocalResourceObject("b625fe0e-0322-48de-bc1f-472019ffd5e7.DuplicateAssociationMessage").ToString(), 90, 360);
							return;
						}
					}
				}
