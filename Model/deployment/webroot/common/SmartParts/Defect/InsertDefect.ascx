...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklProject" PickListName="Project" AlphaSort="true" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklStatus" PickListName="Defect Status" StorageMode="ID"  />
  </div>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkSubmitSpeedSearch"  Text="<%$ resources: chkSubmitSpeedSearch.Caption %>"  CssClass=""
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklVersionFound" PickListName="Defect Version Found" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklSource" PickListName="Defect Source" AlphaSort="true" StorageMode="ID"  />
  </div>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkApproveSpeedSearch"  Text="<%$ resources: chkApproveSpeedSearch.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklTargetVersion" PickListName="Defect Target Version" MustExistInList="false" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklType" PickListName="Defect Type" AlphaSort="true" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklPublicAccess" PickListName="Ticket Activity Public Access" NoneEditable="true" AlphaSort="true" StorageMode="ID"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklProgress" PickListName="Defect Resolution" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklPriority" PickListName="Defect Priority" StorageMode="ID"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklFixedVersion" PickListName="Defect Fixed in Build" StorageMode="ID"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklSeverity" PickListName="Defect Severity" StorageMode="ID"  />
  </div>
...
<DependentLookups>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklFrequency" PickListName="Defect Frequency" AlphaSort="true" StorageMode="ID"  />
  </div>
...
<asp:TextBox runat="server" ID="txtResolution"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
 ...
 AlternateText="<%$ resources: cmdSave.Caption %>"  ToolTip="<%$ resources: cmdSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=InsertDefect&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkInsertDefectHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="InsertDefect" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
ClientBindingMgr.SetFocusTo(pklProject);
