...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol"  > 
    <SalesLogix:SlxUserControl runat="server" ID="usrUser" Enabled="false" ReadOnly="true" ButtonToolTip="<%$ resources: usrUser.ButtonToolTip %>"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtNewPassword"  dojoType="Sage.UI.Controls.TextBox" TextMode="Password"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtConfirmPassword"  dojoType="Sage.UI.Controls.TextBox" TextMode="Password"  />
  </div>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="UserChangePassword_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=UserChangePassword&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkUserChangePasswordHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="UserChangePassword" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
