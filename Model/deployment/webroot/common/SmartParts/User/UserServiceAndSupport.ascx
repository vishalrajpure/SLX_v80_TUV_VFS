...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxAvailableCalls"  Text="<%$ resources: chkbxAvailableCalls.Caption %>"  CssClass=""
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxNotifyNewTicket"  Text="<%$ resources: chkbxNotifyNewTicket.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxPortalAccess"  Text="<%$ resources: chkbxPortalAccess.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxApproveSpeedSearch"  Text="<%$ resources: chkbxApproveSpeedSearch.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxSpeedSearchSubmissions"  Text="<%$ resources: chkbxSpeedSearchSubmissions.Caption %>"  CssClass=""
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkbxNotifyNewDefect"  Text="<%$ resources: chkbxNotifyNewDefect.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<asp:TextBox runat="server" ID="txtTicketPrefix" Enabled="false" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
 ...
 ToolTip="<%$ resources: btnSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=UserServiceAndSupport&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkUserServiceAndSupportHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="UserServiceAndSupport" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
