...
<asp:TextBox runat="server" ID="txtCompany"  dojoType="Sage.UI.Controls.TextBox" MaxLength="128"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtPinNumber"  dojoType="Sage.UI.Controls.TextBox" MaxLength="32"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol address"  >
    <SalesLogix:AddressControl runat="server" ID="addrWork" AddressDescriptionPickListName="Address Description (Account)" AddressDescriptionPickListId="kSYST0000014" ButtonToolTip="<%$ resources: addrWork.ButtonToolTip %>" AddressToolTip="<%$ resources: addrWork.AddressToolTip %>" IsPrimaryVisible="false" IsMailingVisible="false" >
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtAccountingId"  dojoType="Sage.UI.Controls.TextBox" MaxLength="512"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtEmployeeNum"  dojoType="Sage.UI.Controls.TextBox" MaxLength="12"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtAssetNum"  dojoType="Sage.UI.Controls.TextBox" MaxLength="12"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtAssetDesc"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol address"  >
    <SalesLogix:AddressControl runat="server" ID="addrHome" AddressDescriptionPickListName="Address Description (Contact)" AddressDescriptionPickListId="kSYST0000014" ButtonToolTip="<%$ resources: addrHome.ButtonToolTip %>" AddressToolTip="<%$ resources: addrHome.AddressToolTip %>" IsPrimaryVisible="false" IsMailingVisible="false" >
<AddressDescStyle Height="80"></AddressDescStyle> </SalesLogix:AddressControl>
</div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpHireDate" ToolTip="<%$ resources: dtpHireDate.ToolTip %>" ButtonToolTip="<%$ resources: dtpHireDate.ButtonToolTip %>" DisplayTime="false" Timeless="true" />
  </div>
...
<asp:TextBox runat="server" ID="txtSpouse"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSSN"  dojoType="Sage.UI.Controls.TextBox" MaxLength="12"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtPBirthDate" ToolTip="<%$ resources: dtPBirthDate.ToolTip %>" ButtonToolTip="<%$ resources: dtPBirthDate.ButtonToolTip %>" DisplayTime="false" Timeless="true" />
  </div>
...
<tr>
 ...
 AlternateText="<%$ resources: btnSave.Caption %>"  ToolTip="<%$ resources: btnSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=UserEmployee&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkUserEmployeeHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="UserEmployee" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
