...
<SalesLogix:ScriptResourceProvider ID="RoleUsersgrdRoles_AddRelationTool_Strings" runat="server">
    <Keys>
        ...
        <SalesLogix:ResourceKeyName Key="grdRoles_AddRelationTool.DialogButtonText" />
						<SalesLogix:ResourceKeyName Key="grdRoles_AddRelationTool.LookupProperties.UserInfo.UserName.PropertyHeader" />
		 		<SalesLogix:ResourceKeyName Key="grdRoles_AddRelationTool.LookupProperties.UserInfo.Division.PropertyHeader" />
		 		<SalesLogix:ResourceKeyName Key="grdRoles_AddRelationTool.LookupProperties.UserInfo.Region.PropertyHeader" />
		 		<SalesLogix:ResourceKeyName Key="grdRoles_AddRelationTool.LookupProperties.Type.PropertyHeader" />
		       </Keys>
</SalesLogix:ScriptResourceProvider>

	  	   

<SalesLogix:ScriptResourceProvider ID="RoleUsersgrdRoles_Strings" runat="server">
    <Keys>
       ...
       <SalesLogix:ResourceKeyName Key="grdRoles.cc7540c6-a0ff-4e90-b21a-3b7bfd60a601.ColumnHeading" />
...
<div style="display:none;">
  <asp:TextBox runat="server" ID="RoleUsersgrdRoles_DataCarrier" class="RoleUsersgrdRoles_DataCarrier" ></asp:TextBox>
</div>
  <div id="RoleUsersgrdRoles_Container" style="width:100%;height:100%;" class="">
    <div id="RoleUsersgrdRoles_Grid" style="width:100%;height:100%;"
...
></div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="RoleUsers_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=RoleUsers&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkRoleUsersHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="RoleUsers" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
 </SalesLogix:SmartPartToolsContainer>
...
protected void grdRoles_InsertAssociationAction(object sender, EventArgs e) {
	    ...
	    string text = Request.Form.Get(RoleUsersgrdRoles_DataCarrier.UniqueID);
    if (text.Length > 0)
    {
    var feed = new Sage.Integration.Entity.Feeds.UserRoleFeed();
		...
		if (transformer != null && entity != null && entity.Users.Count == 0)
		{
 ...
 if (entity != null) 
      ...
      { 
          ...
          var transformer = 
              Sage.Platform.Application.ApplicationContext.Current.Services.Get 
                  <Sage.Platform.SData.IAtomEntryToEntityTransformationService>(); 
          foreach (Sage.Entity.Interfaces.IUserRole item in entity.Users) 
          { 
          ...
          RoleUsersgrdRoles_DataCarrier.Text = text; 
          entity.Users.Clear(); 
      } 
 } 
...
btnEditForm.Visible = false;
                                ...
                                script.AppendLine("require(['" + Page.ResolveUrl("~/SmartParts/Role/RoleUsers.js") + "'], function () {");
                                if (Page.IsPostBack)
                                {
                                    script.Append(" Sage.UI.Forms.RoleUsers.init({workspace: '" + getMyWorkspace() + "'} );");
                                }
                                else 
                                {
                                    script.AppendLine("require(['dojo/ready'], function(ready) {");
                                    script.Append("ready(function () {Sage.UI.Forms.RoleUsers.init({workspace: '" + getMyWorkspace() + "'} ); });");
                                    script.AppendLine("});");//end ready require
                                }

                                script.AppendLine("});");// end require
                                ScriptManager.RegisterStartupScript(this, GetType(), "initialize_RoleUsers", script.ToString(), true);
