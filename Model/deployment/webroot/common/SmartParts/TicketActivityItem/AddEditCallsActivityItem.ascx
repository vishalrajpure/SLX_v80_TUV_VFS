<%@ Control Language="C#" ClassName="AddEditCallsActivityItem" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:LookupControl runat="server" ID="lueProduct" ButtonToolTip="<%$ resources: lueProduct.ButtonToolTip %>" ReadOnly="true" Enabled="false" EnableLookup="false" LookupEntityName="Product"  >
<LookupProperties>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditCallsActivityItem_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditCallsActivityItem&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditCallsActivityItemHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditCallsActivityItem" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditCallsActivityItemAdapter(this)); }
}

public class AddEditCallsActivityItemAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditCallsActivityItem
{
    public AddEditCallsActivityItemAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
