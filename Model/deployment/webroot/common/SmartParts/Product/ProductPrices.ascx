...
<Columns>
   <asp:BoundField DataField="Program"
    ...
    <itemtemplate>
 <SalesLogix:Currency runat="server" ID="grdProductPricescol2" DisplayMode="AsText"  ExchangeRateType="BaseRate"   Text='<%#  dtsProductPrices.getPropertyValue(Container.DataItem, "Price")  %>' CssClass=""  DecimalDigits="2"  />
...
protected void grdProductPrices_RowCommand(object sender, GridViewCommandEventArgs e)
{
    ...
    if (Int32.TryParse(e.CommandArgument.ToString(), out rowIndex))
    {
        ...
        if (e.CommandName.Equals("Edit"))
        {
            ...
            {
                // QFDataGrid
                            DialogService.SetSpecs(215, 550, "AddEditProductPrice", GetLocalResourceObject("52b6dfe8-d316-4aa5-a7d3-f0c74b14505f.DialogTitleOverride").ToString() );
 ...
 ToolTip="<%$ resources: btnAddPrice.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=plus_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=ProductPrices&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkProductPricesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="ProductPrices" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
grdProductPrices.Columns[3].Visible = (RoleSecurityService.HasAccess("Entities/Product/Edit"));
grdProductPrices.Columns[4].Visible = (RoleSecurityService.HasAccess("Entities/Product/Delete"));
