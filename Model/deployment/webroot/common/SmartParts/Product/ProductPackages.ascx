...
protected void grdPackages_Sorting(object sender, GridViewSortEventArgs e) { }
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="ProductPackages_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=ProductPackages&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkProductPackagesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="ProductPackages" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
public Sage.Platform.WebPortal.Binding.WebHqlListBindingSource hqlPackagesDataSource
{
    get
    {
        if (_hqlPackagesDataSource == null)
        {
            ...
            _hqlPackagesDataSource.Where = "packageProduct.Package.Id = package.Id and packageProduct.Product.Id = :productId";
...
if (hqlPackagesDataSource.Current != null) { hqlPackagesDataSource.Bind(); }
 grdPackages.DataBind(); 
...
public class ProductPackagesAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IProductPackages
{
    ...
    private Sage.Platform.Controls.IDataSourceControl _hqlPackagesDataSource;
    public  Sage.Platform.Controls.IDataSourceControl hqlPackagesDataSource
    {
        get { return FindControl(ref _hqlPackagesDataSource, "hqlPackagesDataSource"); }
    }
