...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueReceivedProduct.LookupProperties.AccountProduct.ProductName.PropertyHeader %>" PropertyName="AccountProduct.ProductName" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueReceivedProduct.LookupProperties.AccountProduct.ActualId.PropertyHeader %>" PropertyName="AccountProduct.ActualId" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueReceivedProduct.LookupProperties.AccountProduct.SerialNumber.PropertyHeader %>" PropertyName="AccountProduct.SerialNumber" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
...
<asp:TextBox runat="server" ID="txtRecSKU" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtRecSerialNumber" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<div class="slxlabel  alignleft checkboxRight">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkExists"  Text="<%$ resources: chkExists.Caption %>"  CssClass=""
...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.ActualId.PropertyHeader %>" PropertyName="ActualId" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.Name.PropertyHeader %>" PropertyName="Name" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.Type.PropertyHeader %>" PropertyName="Type" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueProduct.LookupProperties.Status.PropertyHeader %>" PropertyName="Status" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
</SalesLogix:LookupControl>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtProductSKU" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<div class="slxlabel  alignleft checkboxRight">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="chkShipped"  Text="<%$ resources: chkShipped.Caption %>"  CssClass=""
LabelPlacement="left" AutoPostBack="true"  />
</div>
      </td>
      </tr>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditReturnShippedProduct_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditReturnShippedProduct&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditReturnShippedProductHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditReturnShippedProduct" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
