...
<SalesLogix:LookupControl runat="server" ID="lueCompetitorPref" ButtonToolTip="<%$ resources: lueCompetitorPref.ButtonToolTip %>" LookupEntityName="Competitor" LookupEntityTypeName="Sage.Entity.Interfaces.ICompetitor, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"  >
<LookupProperties>
