<%@ Control Language="C#" ClassName="AddEditDistribution" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="plkDiscriptionType" PickListName="DistributionType" MustExistInList="false" Required="true" MaxLength="32"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="plkTypeOfCopy" PickListName="TypeOfCopyForDistribution" MustExistInList="false" Required="true" MaxLength="32"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditDistribution_RTools" ToolbarLocation="right">
 ...
 ToolTip="<%$ resources: btnSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditDistribution&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditDistributionHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditDistribution" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
if (EntityContext.EntityID.ToString().ToUpper().Equals("INSERT") == true)
{
 if (IRNR.Distributions.Count > 0)
 {
	foreach (Sage.Entity.Interfaces.IDistribution obj in IRNR.Distributions)
	{
	    ...
	    {
	        throw new Sage.Platform.Application.ValidationException("Distribution Type already Present in list"); 
	    } 
}}}
if(DR.Quantity <=0 || DR.Quantity == null)
{
	throw new Sage.Platform.Application.ValidationException("Please enter Quantity..."); 
}
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditDistributionAdapter(this)); }
}

public class AddEditDistributionAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditDistribution
{
    public AddEditDistributionAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
