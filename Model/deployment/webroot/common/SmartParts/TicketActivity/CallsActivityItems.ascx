<%@ Control Language="C#" ClassName="CallsActivityItems" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:ScriptResourceProvider ID="CallsActivityItemsgrdActivityParts_AddRelationTool_Strings" runat="server">
    <Keys>
...
<SalesLogix:ScriptResourceProvider ID="CallsActivityItemsgrdActivityParts_Strings" runat="server">
    <Keys>
...
<div style="display:none;">
  <asp:TextBox runat="server" ID="CallsActivityItemsgrdActivityParts_DataCarrier" class="CallsActivityItemsgrdActivityParts_DataCarrier" ></asp:TextBox>
</div>
  <div id="CallsActivityItemsgrdActivityParts_Container" style="width:100%;height:100%;" class="">
    <div id="CallsActivityItemsgrdActivityParts_Grid" style="width:100%;height:100%;"
...
></div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="CallsActivityItems_RTools" ToolbarLocation="right">
 ...
 <SalesLogix:PageLink ID="lnkCallsActivityItemsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="CallsActivityItems" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
 </SalesLogix:SmartPartToolsContainer>

<SalesLogix:ScriptResourceProvider ID="CallsActivityItemsResources" runat="server">
<Keys>
...
protected void grdActivityParts_InsertAssociationAction(object sender, EventArgs e) {
	    ...
	    string text = Request.Form.Get(CallsActivityItemsgrdActivityParts_DataCarrier.UniqueID);
    if (text.Length > 0)
    {
...
protected override void OnFormBound()
{
 ...
 if (entity != null) 
      ...
      { 
          ...
          CallsActivityItemsgrdActivityParts_DataCarrier.Text = text; 
          entity.Items.Clear(); 
      } 
 } 
...
btnEditForm.Visible = false;
                                ...
                                script.AppendLine("require(['" + Page.ResolveUrl("~/SmartParts/TicketActivity/CallsActivityItems.js") + "'], function () {");
                                if (Page.IsPostBack)
                                {
                                    script.Append(" Sage.UI.Forms.CallsActivityItems.init({workspace: '" + getMyWorkspace() + "'} );");
                                }
                                else 
                                {
                                    script.AppendLine("require(['dojo/ready'], function(ready) {");
                                    script.Append("ready(function () {Sage.UI.Forms.CallsActivityItems.init({workspace: '" + getMyWorkspace() + "'} ); });");
                                    script.AppendLine("});");//end ready require
                                }

                                script.AppendLine("});");// end require
                                ScriptManager.RegisterStartupScript(this, GetType(), "initialize_CallsActivityItems", script.ToString(), true);
...
{
    get { return _formAdapter ?? (_formAdapter = new CallsActivityItemsAdapter(this)); }
}

public class CallsActivityItemsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ICallsActivityItems
{
    public CallsActivityItemsAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
