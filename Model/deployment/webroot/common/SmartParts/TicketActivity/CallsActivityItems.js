...
Sage.UI.Forms.CallsActivityItems = {
...
makeGrid : function(runtimeConfig) {
    ...
    if (typeof CallsActivityItemsgrdActivityParts_Strings === 'undefined') {
        CallsActivityItemsgrdActivityParts_Strings = {};
    }

    var options = {		
		        context: runtimeConfig,		
		        noDataMessage: CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_EmptyTableRowText']  ||  'No records match the selection criteria.', 
...

{
    ...
    if (Sage.Utility.getModeId() === 'insert') {
		...
		name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_a116eddf_12f1_44ba_b510_7e40e6f6e59c_ColumnHeading']  || '',
	sortable: false,
		width: 10,
		styles: 'width:auto;',
...
,
	   	type: SlxEdit,
		cellValue: CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_a116eddf_12f1_44ba_b510_7e40e6f6e59c_Text']  || 'Edit Part',
		entityType: 'Sage.Entity.Interfaces.ITicketActivityItem, Sage.Entity.Interfaces',
		smartPart: 'AddEditTicketActivityItem',
		dialogTitle: CallsActivityItemsgrdActivityParts_Strings['c66600f9_1fe4_4821_9ece_c93d5457d9f6_DialogTitleOverride'] || '',
		isCentered: true ,
		dialogTop: 0,
		dialogLeft: 0,
		dialogHeight: 400,
		dialogWidth: 400,
    	formObjectName: 'Sage.UI.Forms.CallsActivityItems'
    	    }
  	,
{
		field: 'AccountProduct.ProductName',
				name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_9d3402ca_f3c1_4cb5_b118_016de4349de1_ColumnHeading']  || 'Product',
	sortable: true,
		width: 15,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
  	...
  	,
{
		field: 'AccountProduct.SerialNumber',
				name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_b1165945_e43b_4cc8_bb56_630e3e80535c_ColumnHeading']  || 'Serial Number',
	sortable: true,
		width: 10,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
  	...
  	,
{
		field: 'AccountProduct.ActualId',
				name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_5ece826e_d3e3_482d_8c0f_ea72bc664897_ColumnHeading']  || 'SKU',
	sortable: true,
		width: 12,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
{
		field: 'ItemAmount',
				name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_8e9dc831_b1fd_43e0_b6f5_dfb0c44d751f_ColumnHeading']  || 'Price',
	sortable: true,
		width: 10,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
  										...
  										,
{
		field: 'ItemDescription',
				name:  CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_86f7a539_714d_4ae1_ae45_af0c526e277b_ColumnHeading']  || 'Description',
	sortable: false,
		width: '10',
	 	styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
, 
	...
	editable: false
	    ...
	    //The .net vehicle to store grid data on postback
            dataCarrierId: 'CallsActivityItemsgrdActivityParts_DataCarrier',
            sort: [
  ...
  controlConfig : 
{
  ...
  btnToolTip :  CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_ButtonTooltip']  ||  'Associate Part', 
  btnIcon:  '~/ImageResource.axd?scope=global&type=Global_Images&key=plus_16x16'  ,
  dialogButtonText : CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_DialogButtonText']  ||  'Add Selected', 
  displayMode : 4, //$ {qf control . LookupDisplayMode}  When adding other dijit templates, need to convert control to use enum values
  dialogTitle : CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_LookupDialogTitle']  ||  'Lookup Part',
      structure : [
     {
       ...
       cells: [
		...
		return anchor;
		 ...
		 {
		   name: CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_LookupProperties_ActualId_PropertyHeader']  || 'SKU',
		   field: 'ActualId',
         ...
         ,
		 {
		   name: CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_LookupProperties_Name_PropertyHeader']  || 'Name',
		   field: 'Name',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 18,
         ...
         ,
		 {
		   name: CallsActivityItemsgrdActivityParts_AddRelationTool_Strings['grdActivityParts_AddRelationTool_LookupProperties_Status_PropertyHeader']  || 'Status',
		   field: 'Status',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 18,
  ...
  ,
 {
    id : 'CallsActivityItems_btnCopy',
  displayInInsert : false,
  imageClass: 'icon_Copy_16x16',  'alternateText' : CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_btnCopy_ToolTip'] || 'Copy Part',
          'handler' : function () {
  ...
  ,
{
    id : 'CallsActivityItems_Delete',
  displayInInsert : false,
  imageClass: 'icon_Delete_16x16',  'alternateText' : CallsActivityItemsgrdActivityParts_Strings['grdActivityParts_Delete_ToolTip'] || 'Remove',
        ...
        contextualCondition: function() { return 'TicketActivity.Id eq "' + Sage.Utility.getCurrentEntityId() + '"'; },
						...
						tabId : 'CallsActivityItems',
		gridNodeId: 'CallsActivityItemsgrdActivityParts_Grid',
				id : 'CallsActivityItemsgrdActivityParts',
        rowsPerPage: 20,
  ...
  ,
    ...
    init : function(runtimeConfig) {
        setTimeout(function() { Sage.UI.Forms.CallsActivityItems.makeGrid(runtimeConfig); }, 1);
