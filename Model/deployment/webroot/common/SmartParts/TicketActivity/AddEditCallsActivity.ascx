<%@ Control Language="C#" ClassName="AddEditCallsActivity" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
LabelPlacement="right"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditCallsActivity_RTools" ToolbarLocation="right">
 ...
 AlternateText="<%$ resources: cmdSave.Caption %>"  ToolTip="<%$ resources: cmdSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditCallsActivity&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditCallsActivityHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditCallsActivity" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding lueChargeTypeLookupResultValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("RateTypeDescription", lueChargeType, "LookupResultValue");
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditCallsActivityAdapter(this)); }
}

public class AddEditCallsActivityAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditCallsActivity
{
    public AddEditCallsActivityAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
