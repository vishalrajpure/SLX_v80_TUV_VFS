<%@ Control Language="C#" ClassName="DefectActivityRateExtendedDetails" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<tr>
            <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="txtModifiyUser_lbl" AssociatedControlID="txtModifiyUser" runat="server" Text="<%$ resources: txtModifiyUser.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtModifiyUser" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="DefectActivityRateExtendedDetails_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=DefectActivityRateExtendedDetails&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkDefectActivityRateExtendedDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="DefectActivityRateExtendedDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
        ...
        BindingSource.Bindings.Add(dteCreateDateDateTimeValueBinding);
                    // txtModifiyUser.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding txtModifiyUserTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ModifyUser", txtModifiyUser, "Text");
        BindingSource.Bindings.Add(txtModifiyUserTextBinding);
...
{
    get { return _formAdapter ?? (_formAdapter = new DefectActivityRateExtendedDetailsAdapter(this)); }
}

public class DefectActivityRateExtendedDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IDefectActivityRateExtendedDetails
{
    public DefectActivityRateExtendedDetailsAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
    ...
    private Sage.Platform.Controls.ITextBoxControl _txtModifiyUser;
    public  Sage.Platform.Controls.ITextBoxControl txtModifiyUser
    {
        get { return FindControl(ref _txtModifiyUser, "txtModifiyUser"); }
    }
