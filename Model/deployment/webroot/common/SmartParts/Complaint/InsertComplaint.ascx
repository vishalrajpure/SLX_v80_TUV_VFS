<%@ Control Language="C#" ClassName="InsertComplaint" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<LookupPreFilters>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpComplaintDate" ReadOnly="true" DisplayTime="false" />
  </div>
...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueSubJob.LookupProperties.BranchId.PropertyHeader %>" PropertyName="BranchId" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtCorrectionNC"  Rows="4" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea" MultiLineMaxLength="2147483647"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="InsertComplaint_RTools" ToolbarLocation="right">
    <asp:ImageButton runat="server" ID="QFButton"
ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=InsertComplaint&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkInsertComplaintHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="InsertComplaint" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
conObj1.Open();
string query1 = "Select Isnull(MAx(substring(ComplaintNumber,CHARINDEX('/',ComplaintNumber,16)+1,len(ComplaintNumber))),0) +1 cmp from complaint";
...
{
	string lc_EntityType = Convert.ToString(Request.QueryString["type"]);
	Complaint.EntityType = lc_EntityType;
	if(lc_EntityType=="Appeal")
	{
		dtpComplaintDate_lbl.Text="Appeal Date";
		page.TitleBar.Text = "Insert Appeal";		
	...
	else
	{
		...
		page.TitleBar.Text = "Insert Complaint";		
...
{
    get { return _formAdapter ?? (_formAdapter = new InsertComplaintAdapter(this)); }
}

public class InsertComplaintAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IInsertComplaint
{
    public InsertComplaintAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
