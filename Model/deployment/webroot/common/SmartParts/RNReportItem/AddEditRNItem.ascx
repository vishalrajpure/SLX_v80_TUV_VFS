<%@ Control Language="C#" ClassName="AddEditRNItem" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:LookupControl runat="server" ID="lueItemCode" LookupEntityName="TicketProduct" LookupEntityTypeName="Sage.Entity.Interfaces.ITicketProduct, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" SeedProperty="RNReport.TicketId" AutoPostBack="true"  >
<LookupProperties>
...
LabelPlacement="left"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditRNItem_RTools" ToolbarLocation="right">
 ...
 <SalesLogix:PageLink ID="lnkAddEditRNItemHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditRNItem" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
if(objitem != null)
{
	objitem.Quantity = objitem.TicketProductduct.ContractProductItem.Quantity;
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditRNItemAdapter(this)); }
}

public class AddEditRNItemAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditRNItem
{
    public AddEditRNItemAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
