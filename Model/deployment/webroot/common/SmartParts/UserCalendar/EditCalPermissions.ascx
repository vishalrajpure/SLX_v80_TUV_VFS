...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
     ...
     <tr>
            <td  >
<asp:Label runat="server" ID="QFLabel" Text="<%$ resources: QFLabel.Text %>"  CssClass="padBottom"  />
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="AllowAdd"  Text="<%$ resources: AllowAdd.Caption %>"  CssClass=""
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="AllowEdit"  Text="<%$ resources: AllowEdit.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="AllowDelete"  Text="<%$ resources: AllowDelete.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
<div class="slxlabel  alignleft  checkbox ">
  ...
  <SalesLogix:SLXCheckBox runat="server" ID="AllowSync"  Text="<%$ resources: AllowSync.Caption %>"  CssClass=""
LabelPlacement="right"  />
</div>
      </td>
      </tr>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="EditCalPermissions_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=EditCalPermissions&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkEditCalPermissionsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="EditCalPermissions" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
