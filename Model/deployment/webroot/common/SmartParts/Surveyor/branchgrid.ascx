<%@ Control Language="C#" ClassName="branchgrid" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<Columns>
   <asp:BoundField DataField="Branch.BranchName"
      HeaderText="<%$ resources: grdBranchSurveyors.a3a92d8c-e109-4bc0-9400-e787d22a73ed.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Branch.BranchCode"
      HeaderText="<%$ resources: grdBranchSurveyors.d69c4730-e4da-4666-a4a2-999c209f1dd7.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:CheckBoxField DataField="IsPrimary" ReadOnly="True"
      HeaderText="<%$ resources: grdBranchSurveyors.c283f1b2-1954-410b-80e9-06b13adc8735.ColumnHeading %>"        >
          </asp:CheckBoxField>
 </Columns>
...
<script runat="server" type="text/C#">
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="branchgrid_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=branchgrid&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkbranchgridHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="branchgrid" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dsBranchSurveyors.BindFieldNames = new String[] { "Id","Branch.BranchName","Branch.BranchCode","IsPrimary" };
...
{
    get { return _formAdapter ?? (_formAdapter = new branchgridAdapter(this)); }
}

public class branchgridAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.Ibranchgrid
{
    public branchgridAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
