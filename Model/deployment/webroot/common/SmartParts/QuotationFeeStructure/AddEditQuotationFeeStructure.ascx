<%@ Control Language="C#" ClassName="AddEditQuotationFeeStructure" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<asp:TextBox runat="server" ID="Description"  dojoType="Sage.UI.Controls.TextBox" MaxLength="128"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditQuotationFeeStructure_CTools" ToolbarLocation="center">
...
ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Delete_16x16"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddEditQuotationFeeStructure_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=AddEditQuotationFeeStructure&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkAddEditQuotationFeeStructureHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddEditQuotationFeeStructure" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
 </SalesLogix:SmartPartToolsContainer>
...
{
    get { return typeof(Sage.Entity.Interfaces.IQuotationFeeStructure); }
}
...
protected void btnSave_ClickAction(object sender, EventArgs e) {
  Sage.Entity.Interfaces.IQuotationFeeStructure _entity = BindingSource.Current as Sage.Entity.Interfaces.IQuotationFeeStructure;
  if (_entity != null)
  {
...
{
    get { return _formAdapter ?? (_formAdapter = new AddEditQuotationFeeStructureAdapter(this)); }
}

public class AddEditQuotationFeeStructureAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddEditQuotationFeeStructure
{
    public AddEditQuotationFeeStructureAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
