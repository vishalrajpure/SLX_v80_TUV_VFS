<%@ Control Language="C#" ClassName="QualificationCategoryDetail" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<tr>
 ...
 <div class=" lbl alignleft" >
   <asp:Label ID="CategoryName_lbl" AssociatedControlID="CategoryName" runat="server" Text="<%$ resources: CategoryName.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="CategoryName" ToolTip="<%$ resources: CategoryName.ToolTip %>"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="QualificationCategoryDetail_RTools" ToolbarLocation="right">
 ...
 />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=QualificationCategoryDetail&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkQualificationCategoryDetailHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="QualificationCategoryDetail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
                 // CategoryName.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding CategoryNameTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("CategoryName", CategoryName, "Text");
        BindingSource.Bindings.Add(CategoryNameTextBinding);
       
   
                }
              
protected void btnSave_ClickAction(object sender, EventArgs e) {
  Sage.Entity.Interfaces.IQualificationCategory _entity = BindingSource.Current as Sage.Entity.Interfaces.IQualificationCategory;
  if (_entity != null)
  {
...
protected void btnSave_ClickActionBRC(object sender, EventArgs e) {
      Response.Redirect(string.Format("QualificationCategory.aspx?entityId={0}", (this.BindingSource.Current as Sage.Platform.ComponentModel.IComponentReference).Id));
...
protected void btnInsertSave_ClickActionBRC(object sender, EventArgs e) {
   Response.Redirect("InsertQualification.aspx?modeid=insert");
...
lib.Execute("QualificationCategoryDetail.OnLoad1", methodArgs);
...
ClientBindingMgr.SetFocusTo(CategoryName);
...
{
    get { return _formAdapter ?? (_formAdapter = new QualificationCategoryDetailAdapter(this)); }
}

public class QualificationCategoryDetailAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IQualificationCategoryDetail
{
    public QualificationCategoryDetailAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}

    private Sage.Platform.Controls.ITextBoxControl _CategoryName;
    public  Sage.Platform.Controls.ITextBoxControl CategoryName
    {
        get { return FindControl(ref _CategoryName, "CategoryName"); }
    }
