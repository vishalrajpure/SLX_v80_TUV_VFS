<%@ Control Language="C#" ClassName="InsertCallsAreaOwner" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:OwnerControl runat="server" ID="ownAssignTo" Types="$qfcontrol.Types"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="InsertCallsAreaOwner_RTools" ToolbarLocation="right">
 ...
 AlternateText="<%$ resources: btnSave.Caption %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=InsertCallsAreaOwner&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkInsertCallsAreaOwnerHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="InsertCallsAreaOwner" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
    get { return _formAdapter ?? (_formAdapter = new InsertCallsAreaOwnerAdapter(this)); }
}

public class InsertCallsAreaOwnerAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IInsertCallsAreaOwner
{
    public InsertCallsAreaOwnerAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
