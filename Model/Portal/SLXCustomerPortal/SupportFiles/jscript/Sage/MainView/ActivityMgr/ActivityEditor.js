...
function (_Widget, _Templated, declare, SingleEntrySDataStore, BindingsManager, utility, _DialogHelpIconMixin,
    ...
    sDataServiceRegistry, fileUtility, attachmentUtility, Lookup, activityEditorStrings, template, domClass, userOptionsUtility) {
    var activityEditor = declare('Sage.MainView.ActivityMgr.ActivityEditor', [_Widget, _Templated], {
        ...
        _applyUserOptionsForNewActivity: function () {
            ...
            var alarmTime = dojoDate.add(d, 'minute', alarmdur * -1);
        ...
        _saveAndClose: function () {
            if (this.mode === 'New') {
                ...
                utility.setValue(this._activityData, 'AlarmTime', utility.Convert.toIsoStringFromDate(this.sel_AlarmDur.get('timeValue')));
