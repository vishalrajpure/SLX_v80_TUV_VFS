...
<ContentTemplate>
    ...
    <script type="text/javascript">
        ...
        require([
            ...
            function (CommonTasksTasklet, on, lang, ready, Utility, construct) {
                var prm = Sys.WebForms.PageRequestManager.getInstance(),
                    ...
                    init = function () {
                        ...
                        var groupContextChangedTrigger = dojo.subscribe('/group/context/changed', function (gMgrSvc, args) {
                            dojo.unsubscribe(groupContextChangedTrigger);
