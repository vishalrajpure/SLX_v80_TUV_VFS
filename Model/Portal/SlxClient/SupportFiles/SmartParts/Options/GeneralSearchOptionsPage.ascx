        ...
        <tr>
            ...
            <td >
                ...
                <span class="textcontrol" id="FaxProviderTextControl">
                    ...
                    <asp:TextBox ID="txtFaxProvider" runat="server"></asp:TextBox>
                </span>
            </td>
        </tr>
        <tr>
        ...
        if (document.getElementById("FaxProviderOptions")) {
            ...
            if (typeof (FaxProviderControl) != "undefined") {
                ...
                require(['Sage/MailMerge/Helper', 'Sage/MailMerge/Service'], function (Helper, DesktopService) {
                    ...
                    if (oService) {
                        var x = oService.MailMergeGUI().GetFaxProviderOptions(FaxProviderControl.value);
                        x = '<select name="FaxOptions" data-dojo-type="Sage.UI.Controls.Select" class="select-control" onchange="updateFaxProvider()">' + x + '</select>';
                        var oFaxProviderOptions = $get("FaxProviderOptions");
                        if (oFaxProviderOptions) {
                            oFaxProviderOptions.innerHTML = x;
                        }
