...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr>
     ...
     <td> <div class="lbl">
            ...
            <div class="textcontrol">
                <SalesLogix:PickListControl runat="server" ID="pklAccountStatus" PickListId="kSYST0000381" 
				PickListName="Account Status" MustExistInList="false"
                    AlphaSort="true" />
            </div> </td>
        
      <td>  <div class="lbl">
                <asp:Label ID="pklCorporateGroup_lz" AssociatedControlID="pklCorporateGroup" runat="server"
				Text="Corporate Group"></asp:Label>
            </div>
            <div class="textcontrol">
                <SalesLogix:PickListControl runat="server" ID="pklCorporateGroup" 
				PickListName="CorporateGroup" AutoPostBack="true"
                    NoneEditable="true"  />
            </div></td>
...
<script runat="server" type="text/C#">
	...
	protected override void OnAddEntityBindings() 
	{
        ...
        BindingSource.Bindings.Add(new WebEntityBinding("Account.LeadSource", lucLeadSource, "LookupResultValue"));
             BindingSource.Bindings.Add(new WebEntityBinding("Account.BranchId", lkpBranch, "LookupResultValue"));
        BindingSource.Bindings.Add(new WebEntityBinding("Account.CorporateGroup", pklCorporateGroup, "PickListValue"));
