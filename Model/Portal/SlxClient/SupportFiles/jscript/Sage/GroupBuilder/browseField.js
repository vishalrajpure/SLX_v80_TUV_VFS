...
function browseField_valueSelected() {
    ...
    if ((window.opener.QueryBuilderMain.currentCondition.getTypeCode() == '11') && (window.opener.document.getElementById("selCondOperator").value.toUpperCase().indexOf('WITHIN') == -1)) {
